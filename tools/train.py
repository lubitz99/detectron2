...
CLASS_NAMES =["__background__", "debris", "fbbpf", "crevicecorrosion"]

# Path of the dataset 
DATASET_ROOT = '../datasets/opg_bscan_full_005'
...
def setup(args):
    ...
    cfg.MODEL.RETINANET.NUM_CLASSES = 4 # Modify the number of class
