...
CLASS_NAMES =["__background__", "rail", "l_bracket"]

# Path of the dataset 
# DATASET_ROOT = './datasets/myDataset'  
DATASET_ROOT = 'datasets/uc2_l_bracket_rail_v003' 
...
PREDEFINED_SPLITS_DATASET = {
    "coco_sandinghose_train": (TRAIN_PATH, TRAIN_JSON),
    "coco_sandinghose_val": (VAL_PATH, VAL_JSON),
}
...
def plain_register_dataset():
    # Training Set 
    DatasetCatalog.register("coco_sandinghose_train", lambda: load_coco_json(TRAIN_JSON, TRAIN_PATH))
    MetadataCatalog.get("coco_sandinghose_train").set(thing_classes=CLASS_NAMES,  
    ...
    # Test/Validation Set
    DatasetCatalog.register("coco_sandinghose_val", lambda: load_coco_json(VAL_JSON, VAL_PATH))
    MetadataCatalog.get("coco_sandinghose_val").set(thing_classes=CLASS_NAMES, 
                                                evaluator_type='coco', # assign the evaluation method 
                                                json_file=VAL_JSON,
                                                image_root=VAL_PATH)
...
def checkout_dataset_annotation(name="coco_sandinghose_val"):
...
def setup(args):
    ...
    cfg.DATASETS.TRAIN = ("coco_sandinghose_train",) # Training set name
    cfg.DATASETS.TEST = ("coco_sandinghose_val",) # Testing set name
    cfg.MODEL.RETINANET.NUM_CLASSES = 3 # Modify the number of class
